    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    browser = _a.sent();
                    return [4 /*yield*/, browser.newContext({ viewport: { width: 1920, height: 1080 } })];
                case 2:
                    context = _a.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, page.goto('https://bookings.cbagenttools.com', { waitUntil: 'domcontentloaded' })];
                case 4:
                    // Start at CBAgentTools login
                    _a.sent();
                    console.log('\n===========================================');
                    ...
                    console.log('===========================================\n');
                    // Wait 10 minutes
                    return [4 /*yield*/, page.waitForTimeout(10 * 60 * 1000)];
                case 5:
                    // Wait 10 minutes
                    _a.sent();
                    // Save the fresh session for future runs
                    return [4 /*yield*/, context.storageState({ path: '.playwright-state.json' })];
                case 6:
                    // Save the fresh session for future runs
                    _a.sent();
