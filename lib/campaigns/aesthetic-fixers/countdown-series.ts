    ...
    return [
        {
            ...
            visualDirectionNotes: `${aestheticLabel} establishing shot of the ship at sea. ${lightingStyle}. Wide and inviting. ${colorPalette.primary} tones, minimal text overlay, no urgency framing or inventory copy.`,
        ...
        },
        {
            ...
            visualDirectionNotes: `${aestheticLabel} destination montage or port arrival scene. ${lightingStyle}. Editorial pacing, destination-forward. No urgency framing, no inventory language.`,
            avatarRequired: false,
