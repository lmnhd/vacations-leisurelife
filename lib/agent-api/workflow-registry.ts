...
const RAW_WORKFLOW_DEFINITIONS = [
    ...
    },
    {
        ...
        displayName: 'Campaign Landing Stills Generate',
        category: 'artifact',
        availability: 'implemented',
        persistsState: true,
        stopsBeforeMedia: true,
        description: 'Regenerate landing still bible from persisted brief and fresh anchors. Does not rerun core brief generation.',
    },
    {
        workflowId: 'campaign_production_bible_generate',
        displayName: 'Campaign Production Bible Generate',
        category: 'artifact',
        availability: 'implemented',
        persistsState: true,
        stopsBeforeMedia: true,
        description: 'Regenerate production bible from persisted brief and saved landing stills. Does not rerun stills or core brief.',
    },
    {
        workflowId: 'campaign_production_lint_resync',
        displayName: 'Campaign Production Lint Resync',
        category: 'artifact',
        availability: 'implemented',
        persistsState: true,
        stopsBeforeMedia: true,
        description: 'Recompute production build lint from persisted artifacts. No LLM calls. Updates stored verdict only if stale.',
    },
    {
        workflowId: 'campaign_status_update',
        displayName: 'Campaign Status Update',
        category: 'campaign',
        availability: 'implemented',
        persistsState: true,
        stopsBeforeMedia: false,
        description: 'Update the persisted campaign lifecycle status so automation can publish or advance a campaign.',
    },
    {
