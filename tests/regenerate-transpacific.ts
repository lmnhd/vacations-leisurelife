/**
 * Regenerate transpacific-vinyl-listening-nov-2026 with fix
...
async function regenerateTranspacific(): Promise<void> {
    console.log('🔄 Regenerating: transpacific-vinyl-listening-nov-2026 (with fix)\n');
...
regenerateTranspacific().catch(console.error);
