/**
 * Blocker Frequency Test - Campaign 1
...
async function testBlockerFrequency1(): Promise<void> {
    console.log('🎯 Blocker Frequency Test - Campaign 1/3\n');
    console.log('Campaign: bp-tabletop-icon-2027-7n-caribbean');
    console.log('Name: Open Tabletop at Sea: Board Games and TTRPGs Without the Tournament\n');
...
testBlockerFrequency1().catch(console.error);
