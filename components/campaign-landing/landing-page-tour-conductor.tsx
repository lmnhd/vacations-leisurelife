...
const SYSTEM_COPY: Record<CampaignLandingViewModel['designSystem']['system'], {
    ...
    system_1_editorial: {
        shell: 'border-teal-950/20 bg-[#f5f8f4] text-slate-950 shadow-[0_28px_80px_rgba(15,83,77,0.14)]',
        input: 'border-teal-950/20 bg-white text-slate-950 placeholder:text-slate-400',
        badge: 'border-teal-950/20 bg-white text-slate-600',
        label: 'EDITORIAL LETTERS',
    },
    system_2_nostalgia: {
        shell: 'border-cyan-950/20 bg-[#eef8f7] text-[#143d3b] shadow-[0_28px_80px_rgba(8,91,101,0.14)]',
        input: 'border-cyan-950/20 bg-white text-[#143d3b] placeholder:text-cyan-950/35',
        badge: 'border-cyan-950/20 bg-white text-[#315f5a]',
        label: 'POSTCARD WIRE',
    },
    system_3_zine: {
        shell: 'border-zinc-950 bg-[#fbf7ff] text-zinc-950 shadow-[9px_9px_0_rgba(0,0,0,0.9)]',
        input: 'border-zinc-950 bg-white text-zinc-950 placeholder:text-zinc-500',
