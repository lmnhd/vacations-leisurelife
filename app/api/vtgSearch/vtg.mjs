...
export function search(url = "https://www.vacationstogo.com/ticker.cfm?incCT=y&sm=202311&tm=202312&r=0&l=14&s=0&n=2&d=0&v=0") {
...
export function getCookies(cookiefile = __dirname + "/cookies.json") {
