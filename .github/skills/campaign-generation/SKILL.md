...
- **Shared campaign documentation location:** For every new campaign or campaign ad, create or use a dedicated, descriptively named subdirectory inside `.github/DOCS/Implementation/DEALS_STRATEGY/LIVE_DEAL_DATA_WORK_DIRECTORY/` (prefer the campaign slug). Store the related research dossier, brief, copy, targeting, media notes, validation results, and approval documentation there so Group and Deal work remains transparent and easy to trace.
